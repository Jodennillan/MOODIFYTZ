...
<div class="pt-10 flex h-screen overflow-hidden bg-gray-50">
            ...
            <div class="p-4">
                <div class="mb-4">
                    <a href="{{ route('peer.group') }}" 
                       class="flex items-center gap-3 px-4 py-3 bg-green-50 text-green-700 rounded-lg font-medium">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('peer.dm', $peer->id) }}"
                           class="flex items-center gap-3 px-4 py-3 hover:bg-gray-100 rounded-lg transition">
                            <div class="relative">
    ...
    <main class="flex-1 flex flex-col">
        <header class="px-6 py-4 border-b bg-white shadow-sm flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">All messages are visible to everyone</p>
            </div>
            <div class="flex items-center gap-2">
                @php
                    $onlineCount = $peers->where('is_online', true)->count();
                @endphp
        ...
        <footer class="p-4 border-t bg-white">
            <form action="{{ route('peer.message.send') }}" method="POST" class="flex items-center gap-3">
                @csrf
